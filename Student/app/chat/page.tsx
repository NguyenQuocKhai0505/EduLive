...
export default function ChatPage() {
  ...
  const messagesEndRef = useRef<HTMLDivElement>(null);
    ...
    return (
        // Container chính: Chiều cao full màn hình trừ đi Navbar (khoảng 80px)
        <div className="flex h-[calc(100vh-80px)] bg-white dark:bg-slate-950 border-t dark:border-slate-800">
